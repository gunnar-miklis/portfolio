  ...
  return (
    <>
      ...
      <div id='projects' style={{ width: '100%' }}>
        <h1 style={{ marginTop: 150 }}>Projects</h1>
      </div>
      ...
      <div className='projects'>
        ...
        >
          <p>
            ...
            tickets&quot; or check-in &quot;Box Office tickets&quot;. Intentionally built for
            offline use, because the current venue has poor internet coverage.
          </p>
        ...
        >
          ...
          <div className='paper paper-spacing'>
            <ul className='list'>
              ...
              <li>
                <PhoneGearIcon /> Progress Stepper, Conditional Next/Back/Finish/Reset
                Functionality.
              </li>
              <li>
